...
**Cumulative test count: 597 collected (2026-07-21); ruff + mypy clean; targeted suites green, full-suite run in progress — last full-suite green: 574 all-pass (2026-07-20). (507 at the v1.0 tag, 2026-07-16; 559 at 2026-07-18; 574 at 2026-07-20 = +15 client-report layer; +23 since = annotator schema v3 + the 2026-07-21 review fixes.)**

## Candidate work not yet committed to a phase

`plans/research_backlog.md` (2026-07-21) holds ~24 curated research paths from three
brainstorming passes — ML, business/operations, and methods for the small-N problem —
each with its blocker, method sketch and honest expected outcome. Nothing there has been
run. Items graduate into a phase plan or get killed with a reason recorded in place. The
highest-readiness item is **F1: run the LLM-annotator pilot** — already built, tested,
pre-registered and never executed (~$33 Opus batch, schema-v3 estimate).
